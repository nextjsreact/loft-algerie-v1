-- Étape 2: Configuration complète du système executive
-- À exécuter APRÈS avoir ajouté le rôle 'executive' à l'enum user_role

-- 1. Créer une table pour les permissions spéciales
...
-- 2. Créer une table pour les métriques sensibles
...
-- 3. Table pour les alertes critiques
...
-- 4. RLS Policies pour les données sensibles
...
-- 5. Créer un utilisateur executive de démonstration
...
-- 6. Accorder toutes les permissions à l'executive
